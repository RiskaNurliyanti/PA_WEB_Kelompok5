    ...
    <section>
        <div class="main-content">
            ...
            <?php 
                ...
                if (isset($_GET['cari'])){
                    $pencarian= $_GET['cari'];
                    $query = "SELECT * FROM game WHERE nama LIKE '%".$pencarian."%' OR gambar LIKE '%".$pencarian."%'";  
                }else{
            ...
            ?>
                ...
                ?>
                <li>
                    <a href="detail.php?id_game=<?php echo $row['id_game'] ?>"><img src="admin/gambar/<?php echo $row['gambar']?>" alt="">
